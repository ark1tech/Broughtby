<script lang="ts">
	...
	import BBStroke from '$lib/broughtby_stroke2.svg';
...
<faq id="faq" class="w-full flex flex-col items-center pt-[11rem] min-h-[100dvh] gap-[2rem]">
	...
	<Accordion.Root class="w-full text-white">
		...
		<Accordion.Item value="item-5" class="border-[#4e535eac]">
			<Accordion.Trigger
				><p class="text-white w-fit text-left">Who runs Broughtby?</p></Accordion.Trigger
			>
			<Accordion.Content
				><p class="w-fit">
...
>
	<div class="flex-1 w-screen h-full absolute z-0 overflow-clip">
		<img src={BBStroke} alt="" class="absolute h-auto lg:w-[50dvw] w-[100dvw] left-[3dvw]" />
	...
	>
		<div class="lg:w-[50%] w-full flex flex-col gap-9 justify-center">
